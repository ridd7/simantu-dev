<section class="section">
  <div class="card">
      <div class="card-header">
          Data Template Rangkaian Tugas
      </div>
      <div class="card-body">
        <div style="text-align: right; margin-bottom: 10px;">
          <button type="button" class="btn btn-primary" onclick="add_alur_tugas()" style="margin-right: 10px;">
        ...
        <table class="table table-border" id="datatable_ajax" style="width: 100%;">
          <thead>
            <tr>
              <th scope="col">#</th>
              <th scope="col">Nama Rangkaian Tugas</th>
